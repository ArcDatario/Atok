			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="activities"><i class="far fa-bell"></i> <span>Activities</span></a> </li>
						...
						<div class="activity">
							<div class="activity-box">
								<ul class="activity-list">
									...
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile" title="Catherine Manseau" data-toggle="tooltip" class="avatar"> <img alt="Catherine Manseau" src="assets/img/profiles/avatar-03.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
											<div class="timeline-content"> <a href="profile" class="name">Catherine Manseau</a> completed <a href="activities">Room booking with payment gateway</a> <span class="time">12 mins ago</span> </div>
										</div> <a class="activity-delete" href="" title="Delete">&times;</a> </li>
									<li class="activity-list_li">
										<div class="activity-user">
										...
										<div class="activity-content">
											<div class="timeline-content"> <a href="profile" class="name">Bernardo Galaviz</a> changed the Room<a href="activities">For available </a> <span class="time">1 day ago</span> </div>
										</div> <a class="activity-delete" href="" title="Delete">&times;</a> </li>
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile" title="Mike Litorus" data-toggle="tooltip" class="avatar"> <img alt="Mike Litorus" src="assets/img/profiles/avatar-05.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
											<div class="timeline-content"> <a href="profile" class="name">Mike Litorus</a> booking new room for <a href="activities"> video conferencing</a> <span class="time">2 days ago</span> </div>
										</div> <a class="activity-delete" href="" title="Delete">&times;</a> </li>
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile" title="Jeffery Lalor" data-toggle="tooltip" class="avatar"> <img alt="Jeffery Lalor" src="assets/img/profiles/avatar-06.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
											<div class="timeline-content"> <a href="profile" class="name">Jeffery Lalor</a> added <a href="profile" class="name">Jeffrey Warden</a> and <a href="profile" class="name">Bernardo Galaviz</a> to the villa <a href="activities">Private </a> <span class="time">7 days ago</span> </div>
										</div> <a class="activity-delete" href="" title="Delete">&times;</a> </li>
								</ul>
							</div>
						</div>
