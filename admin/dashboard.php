<?php
// Add this at the VERY TOP of your dashboard.php
require_once 'auth_check.php';

// No need for session_start() again as auth_check.php already has it
?>
			...
			<div class="content container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-6">
						<div class="card card-chart">
							<div class="card-header">
								<h4 class="card-title">REGISTRATIONS</h4> </div>
							<div class="card-body">
