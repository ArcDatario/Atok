	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index" class="logo"> <img src="assets/img/lock.png" width="50" height="70" alt="logo"> <span class="logoclass">HOTEL</span> </a>
				<a href="index" class="logo logo-small"> <img src="assets/img/lock.png" alt="Logo" width="30" height="30"> </a>
			</div>
