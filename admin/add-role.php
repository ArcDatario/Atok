			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="roles-permissions"><i class="fe fe-vector"></i> <span>Roles & Permissions</span></a> </li>
						...
						<li> <a href="change-password"><i class="fe fe-vector"></i> <span>Change Password</span></a> </li>
