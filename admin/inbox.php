			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li> <a href="pricing"><i class="fe fe-vector"></i> <span>Inbox(21)</span></a> </li>
						<li> <a href="calendar"><i class="fe fe-vector"></i> <span>Starred</span></a> </li>
						<li> <a href="assest"><i class="fe fe-vector"></i> <span>Sent Mail</span></a> </li>
						<li> <a href="activities"><i class="fe fe-vector"></i> <span>Draft(8)</span></a> </li>
						<li> <a href="activities"><i class="fe fe-vector"></i> <span>Trash</span></a> </li>
					</ul>
				</div>
			</div>
		</div>
