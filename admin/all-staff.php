				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Staff </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								<li><a class="active" href="all-staff">All Staff </a></li>
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">All Staff</h4> <a href="add-staff" class="btn btn-primary float-right veiwbutton">Add Staff</a> </div>
						</div>
					</div>
				</div>
				<div class="row">
										...
										<tbody>
											<tr>
												...
												<td class="text-right">
													<div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
														<div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="edit-staff"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
													</div>
												</td>
											</tr>
											<tr>
												<td>
                                                    ...
                                                    <a href="profile">Richard Brobst <span>#0001</span></a>
                                                    </h2>
                                                </td>
												<td>ST-002</td>
											...
											<tr>
												<td>
                                                    ...
                                                    <a href="profile">Ellen Thill <span>#0001</span></a>
                                                    </h2>
                                                </td>
												<td>ST-003</td>
											...
											<tr>
												<td>
                                                    ...
                                                    <a href="profile">Corina Kelsey <span>#0001</span></a>
                                                    </h2>
                                                </td>
												<td>ST-004</td>
											...
											<tr>
												<td>
                                                    ...
                                                    <a href="profile">Carolyn Lane <span>#0001</span></a>
                                                    </h2>
                                                </td>
												<td>ST-005</td>
											...
											<tr>
												<td>
                                                    ...
                                                    <a href="profile">David Alvarez <span>#0001</span></a>
                                                    </h2>
                                                </td>
												<td>ST-006</td>
