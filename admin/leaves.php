...
<li><a class="active" href="leaves">Leaves </a></li>
...
<a href="add-leave" class="btn btn-primary float-right veiwbutton">Add Leave</a>
</div>
</div>
</div>
</div>
...
<a class="dropdown-item" href="edit-leave"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
