...
<li><a class="active" href="holidays">Holidays </a></li>
...
<a href="add-holiday" class="btn btn-primary float-right veiwbutton">Add
Holiday</a>
</div>
</div>
</div>
...
<a class="dropdown-item" href="edit-holiday"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
